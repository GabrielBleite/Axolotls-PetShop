                ...
                call.enqueue(new Callback<Usuario>() {
                    ...
                    public void onResponse(Call<Usuario> call, Response<Usuario> response) {
                        ...
                        if (code == 200) {
                            ...
                            Toast.makeText(getBaseContext(), "Olá " +
                                    usuario.getNomeCompletoCliente() + " seja bem vindo!", Toast.LENGTH_LONG).show();

                            Intent homepage = new Intent(TelaLogin.this, TelaInicial.class);
